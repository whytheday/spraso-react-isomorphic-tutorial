...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsProvider = __webpack_require__(169);

	exports.Provider = _interopRequire(_componentsProvider);

	var _componentsConnect = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStoreShape = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqual = __webpack_require__(172);
	...
	var _utilsWrapActionCreators = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (initialState) {
	  return function () {
	    ...
	    switch (action.type) {
	      case _messageActions.UPDATE_MESSAGE:
	        return Object.assign({}, state, { currentMessage: action.message });
	      case _messageActions.ADD_MESSAGE:
	        var text = state.currentMessage.trim();

	        if (text) {
	          var messages = state.messages.map(function (message) {
	            return Object.assign({}, message);
	          });
	          messages.push({ id: messages.length + 1, text: text });
